---
title: "LLM Wiki 安装与使用教程"
pubDate: "2026-05-11"
description: "LLM Wiki 是 Claude Code 插件：在 Obsidian vault 里用 ingest、compile、query、lint 构建可复合增长的 Karpathy 式 wiki；本文含 Claudian 接入、安装步骤、目录结构与完整工作流。"
hero: "/images/llm-wiki.jpg"
tags: ["Claude Code", "Obsidian", "知识库", "LLM"]
